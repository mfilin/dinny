...
{
    public partial class frmDeliveryList : frmChild
    {
        public Delivery Selected
        {
            get
            {
                return this.grid.SelectedObject as Delivery;
            }
        }
        ...
        {
            IList<Delivery> source = new DeliveryManager().GetAll();
        ...
        private void Edit(Delivery lpEntity)
        {
        ...
        private void extToolStrip_OnAddClick(object sender, EventArgs e)
        {
            Edit(new Delivery {
                    ...
                    docnumber = new DeliveryManager().GetMaxDocNumber() + 1
            });
        }
        ...
        private void extToolStrip_OnDeleteClick(object sender, EventArgs e)
        {
            if (null != this.Selected)
            {
                new DeliveryManager().Delete(this.Selected);
                this.RefreshGrid();
            }
        }
        ...
        private void extToolStrip_OnPrintClick(object sender, EventArgs e)
        {
            if (null != this.Selected)
            {
                dinny.Reports.rptViewer.ExecDelivery(this.Selected);
            }
        }
