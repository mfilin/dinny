...
{
    public partial class frmSettingList : frmChild
    {
        public Setting Selected
        {
            get
            {
                ...
                {
                    Setting row = this.grid.CurrentRow.DataBoundItem as Setting;
                    return row;
                }
                return null;
            }
        ...
        {
            IList<Setting> source = new SettingManager().GetAll();
        ...
        private void Edit(Setting lpEntity)
        {
        ...
        private void extToolStrip_OnDeleteClick(object sender, EventArgs e)
        {
            if (null != this.Selected)
            {
                new SettingManager().Delete(this.Selected);
                this.RefreshGrid();
            }
        }
